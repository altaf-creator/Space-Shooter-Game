Public Class Form1
    ...
    Private Sub Form1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Select Case e.KeyCode
            ...
            Case Keys.F2
                MessageBox.Show("Space Shooter Game" & vbCrLf & "v.1.2" & vbCrLf & "By Altaf" & vbCrLf & "Coded with Visual Basic" & vbCrLf & "Created using Microsoft Visual Studio", "About", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Select
    End Sub
